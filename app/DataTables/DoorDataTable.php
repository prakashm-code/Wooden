...
class DoorDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<Door> $query Results from query() method.
     */
     ...
     *
     * @return QueryBuilder<Door>
     */
    public function query(Door $model, Request $request): QueryBuilder
    {
        $columns = [
            0 => 'id',
            1 => 'name',
        ...
        return Door::query()->orderBy($column, $direction);
    }

...
class PlywoodDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<Plywood> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        <input class="form-check-input status-toggle" type="checkbox" id="color-primary" data-id="' . $row->id . '"  ' . $checked . '>
            ...
            ->addColumn('actions', function ($row) {
                ...
                $delete_url = route('plywood.destroy', $cryptId);
                $edit_url = route('plywood.edit', $cryptId);
     ...
     *
     * @return QueryBuilder<Plywood>
     */
    public function query(Plywood $model, Request $request): QueryBuilder
    {
        $columns = [
            0 => 'id',
            1 => 'name',
        ...
        return Plywood::query()->orderBy($column, $direction);
    }
